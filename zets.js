...
╰───「 *LEVEL UP* 」`)
          ...
          sendButton(from, lvlup, '*Adios*', but)
...
case 'help':
       case 'menu':
teks = `hai Saya Adios-Bot 👋

┌─❏ *Info Bot* 
│❏ヅ *Nama Bot* : Adios-Bot
│❏ヅ *Owner* : Adios
...
┌─❏ *Info User*
│❏ヅ *Nama* : ${pushname}
│❏ヅ *Nomor* : @${sender.split("@")[0]}
│❏ヅ *Status* : User Adios-Bot 
└─────────⎘
┌─❏﻿ *Command*
│❏ヅ${prefix}groupmenu
